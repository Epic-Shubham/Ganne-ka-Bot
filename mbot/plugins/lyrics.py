...
async def sng(bot, message):          
          ...
          try:
            ...
            await message.reply(rpl)
             ...
             await message.reply_text(f"lyrics does not found for `{song}` ", quote = True, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url = f"https://t.me/MuZan_XYZ_Bot")]]))
          finally:
            await message.reply("Check out @MuZan_XYZ_Bot(music)  @MuZan_XYZ_Bot(News)")
